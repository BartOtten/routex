...
making it easier for developers to [contribute to Routex](#pull-requests).
...
Feature requests are welcome and should be discussed on [the Routex topic on the Elixir forum](https://elixirforum.com/t/phoenix-localized-routes-localize-your-phoenix-website-with-multilingual-urls/48486). But take a moment to find
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/routex
