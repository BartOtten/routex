defmodule Routex.Extension do
  ...
  Routex detects callbacks named after either [Phoenix LiveView stages](https://hexdocs.pm/phoenix_live_view/Phoenix.LiveView.html#attach_hook) or [Plug's
  call](https://hexdocs.pm/plug/Plug.html). These callbacks are chained and used by the generated
  `RoutexHelpers.on_mount` and `plug: RoutexHelpers`.
