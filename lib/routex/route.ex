defmodule Routex.Route do
  ...
  """
  @spec get_nesting(route, integer) :: list(integer())
  ...
  """
  @spec group_by_nesting(routes, integer) :: %{list(integer()) => routes}
  ...
  # """
  @spec group_by_method_and_path(routes, integer) :: %{{atom, binary()} => routes}
  ...
  @spec group_by_method_and_path(routes) :: %{{atom, binary()} => routes}
