defmodule Routex.Extension.SimpleLocale.RegistryTest do
  ...
  describe "language/2" do
    ...
    # test "returns language info for valid 3-letter code" do
    #   assert Registry.language("fra") == %{
    #            descriptions: ["French"],
    #            type: :language
    #          }
    # end
  ...
  describe "language?/1" do
    ...
    # test "returns true for valid 3-letter codes" do
    #   assert Registry.language?("eng")
    #   assert Registry.language?("fra")
    #   assert Registry.language?("deu")
    # end
